...
echo "javac -d mods/com.foo.one -p mods 'find src/com.foo.one -name *.java'"
javac -d mods/com.foo.one -p mods `find src/com.foo.one -name '*.java'`

echo "javac -d mods/com.app -p mods 'find src/com.app -name *.java'"
javac -d mods/com.app -p mods `find src/com.app -name '*.java'`

echo "java -p mods -m com.app/com.app.Application"
java -p mods -m com.app/com.app.Application
...
echo "java -p mlibs -m com.app"
java -p mlibs -m com.app
